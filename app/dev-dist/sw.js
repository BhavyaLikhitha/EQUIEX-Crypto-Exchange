...
define(['./workbox-e755d862'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.includes("assets"), new workbox.NetworkFirst({
  ...
  workbox.registerRoute(({
    ...
    return url.pathname.startsWith("/users") || url.pathname.startsWith("/portfolio") || url.pathname.startsWith("/tracker");
  }, new workbox.NetworkFirst({
    "cacheName": "api-calls",
    plugins: [new workbox.ExpirationPlugin({
      maxAgeSeconds: 2592000,
