...
//     location.state?.nft || { name: "", image: "", price: "", description: "" }
//   );

//   const handleSubmit = (e: React.FormEvent) => {
//     e.preventDefault();
//     navigate("/", { state: { nft: nftData, editIndex: location.state?.index } });
//   };
...
//     console.log("Edit NFT with ID:", id);
//   };

//   const handleDeleteNFT = (id: number) => {
//     console.log("Delete NFT with ID:", id);
//   };
...
//         <div className="collect-grid">
//           {myNFTs.map((n) => (
//             <div key={n.id} className="coll-card">
//               <img className='nf-img' src={n.image} alt={n.name} />
//               <h3 className="n-name">{n.name}</h3>
//               <p className="n-plat">Platform: {n.platform}</p>
//               <p className="n-price">Price: {n.price}</p>
//               <p>Data: {n.data}</p>
//               <div className="card-actions">
//                 <button className="mint-btn" onClick={() => handleEditNFT(n.id)}>Edit</button>
//                 <button className="mint-btn" onClick={() => handleDeleteNFT(n.id)}>Delete</button>
//               </div>
//             </div>
//           ))}
//         </div>
